                                ...
                                std::function<void(const QString&)> onError)
{
    ...
    NetworkRequest::instance().post("/blacklist/create", data, onSuccess, onError, 300000);
}
                                        ...
                                        std::function<void(const QString&)> onError)
{
    ...
    // 查询操作可能耗时较长，设置5分钟超时
    NetworkRequest::instance().post("/testset/query", requestBody, onSuccess, onError, 300000);
}
